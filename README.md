<h1>Asif-Designer-Portfolio-Website</h1>
...
To run **Asif-Designer-Portfolio** locally, run this command on your git bash:

Linux and macOS:

```bash
sudo git clone https://github.com/Asifmohamed007/Asif-Designer-Portfolio.git
```

Windows:

```bash
git clone https://github.com/Asifmohamed007/Asif-Designer-Portfolio.git
```
